...
contract MemeLottoToken is ERC20, Ownable, ERC20Detailed {
    ...
    address constant MasterWallet = 0x2fe43187BbbCE3Edb60624a7Ea09C129d3fa28Aa; //[0] Supporter Members/ Affiliate Members/ Community Members/ Player Members
    ...
    address constant MemeLottoPLCAllocationWallet =
        0xF510997854Ead27FF2FAaF23f188577FAe4b1f1d; // [3] Locked token account. Locked for 24 months
    address constant MemeLottoPLCAllocationUnlockedTokensWallet =
        0xDb2799E74a7981F1bC7E5704d3960670618AbFcD; // [4] 15%
    address constant AirdropWallet = 0x3B15aF967fD6e21d1468171CC41dD1Ebf84e0315; // [5] Aidrop
        ...
        onlyOwner
    {
        ...
        lockTokens(receiver, amount, block.timestamp + 90 days, 50); // 90days

        // Schedule additional unlocking events every 30 days
        uint256 unlockTime = block.timestamp + 120 days; // 90 + 30 days
        for (uint256 i = 0; i < 5; i++) {
            unlockTime += 1 days;
            lockTokens(receiver, amount, unlockTime, 10);
        }
    }
